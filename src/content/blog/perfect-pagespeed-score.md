...
body: |
  ...
  A 100/100 score isn't just about vanity metrics. Google uses PageSpeed scores as
  part of their ranking signals, and fast sites convert better. Users abandon sites
  that take more than 3 seconds to load, so speed directly impacts your bottom line.

  ## 1. Ship less JavaScript

  The single biggest cause of poor scores is too much JavaScript. Build with a
  framework like [Astro](/blog/perfect-pagespeed-score/) that ships zero JS by
  ...
  * Lazy-load anything below the fold.
  ...
  If you're struggling to get a perfect score, I can help. [Get in touch](/contact)
  and let's build a site that's as fast as it is beautiful.
---
